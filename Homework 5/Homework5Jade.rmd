...
If you drew a different set of 1000 bootstrap samples and calculated the 95% bootstrap confidence 
interval, how do you think the new interval will compare with the interval reported in part (d)? 
Answer this before doing part (g) below. This question will only be graded for effort. 
