...
I chose the confidence level of 90% to test the claim that Oat Bran decrease serum cholesterol. With this confidence interval we can determine that there is 95% confidence that the mean decrease in serum cholesterol will fall between 5.3 and 5.645mmol/L. The mean of the differences between Oat Bran serum cholestorl and that of Corn Flake cholesterol is 0.345.
